...
function badgermct_menu() {
    add_menu_page('badgerMCT', 'badgerMCT', 'moderate_comments', $badgermct_menu_slug, 'badgermct_dashboard_page');
}
...
function badgermct_culture() {
    add_submenu_page($badgermct_menu_slug, 'Manage Culture', 'Culture', 'moderate_comments', $badgermct_menu_slug, 'badgermct_culture_page', 2);
}
function badgermct_grain() {
    add_submenu_page($badgermct_menu_slug, 'Manage Grain', 'Grain', 'moderate_comments', $badgermct_menu_slug,'badgermct_grain_page', 3);
}
function badgermct_substrate() {
    add_submenu_page($badgermct_menu_slug, 'Mange Substrate', 'Substrate', 'moderate_comments', $badgermct_menu_slug, 'badgermct_substrate_page', 4);
}
function badgermct_harvest() {
    add_submenu_page($badgermct_menu_slug, 'Mange Harvest', 'Harvest', 'moderate_comments', $badgermct_menu_slug, 'badgermct_harvest_page', 5);
}
function badgermct_vendors() {
    add_submenu_page($badgermct_menu_slug, 'Manage Vendors', 'Vendors', 'moderate_comments', $badgermct_menu_slug, 'badgermct_vendors_page', 6);
}
